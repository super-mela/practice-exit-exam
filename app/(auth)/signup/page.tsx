          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <button className="p-2 rounded-md text-white bg-gradient-to-l from-cyan-500 to-blue-500 w-full">
                    Sign up
                  </button>
                </div>
              </div>
            ...
            <form>
              ...
              <div className="flex flex-wrap -mx-3">
                <div className="w-full px-3">
                  <button className="w-full py-2 rounded-md px-0 text-white bg-gradient-to-l from-red-500 to-[#ff9d00]  relative flex items-center">
                    <svg
